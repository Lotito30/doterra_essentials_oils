        ...
        try:
            ...
            if Review.objects.filter(product=product).exists():
                ...
                for review in reviews:
                    ...
                    item['user'] = review.user.first_name + " " + review.user.last_name
            ...
            return Response(
                {'error':'Something weent wrong when retrieving reviews'}
            )
    ...
    def get(self, request, productId, format=None):
        ...
        try:
            ...
            if Review.objects.filter(user=user, product=product).exists():
                ...
                result['user'] = review.user.first_name + " " + review.user.last_name
