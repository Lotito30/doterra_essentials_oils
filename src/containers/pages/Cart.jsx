  ...
  const showItems = () => {
    return items?.length !== 0 ? (
      ...
      <div className="flex flex-col items-center justify-center gap-3 py-4">
        <svg
          title="CartShoppingBagIcon"
          class="state_container__icon"
          width="93"
          height="83"
          viewBox="0 0 93 83"
          fill="none"
    ...
    if (total_items < 1) {
      ...
      return (
        <div className="grid grid-cols-2 gap-2 ">
          <Link
            to="/checkout"
            className="text-center bg-orange-standard border border-transparent rounded-md shadow-sm py-3 px-4 text-base font-medium text-white hover:bg-black focus:outline-none focus:ring-0  transition ease-in-out duration-300 flex items-center justify-center"
          >
            Checkout
          </Link>
          <Link
            to="/shop"
            className="inline-block text-center bg-orange-standard border border-transparent rounded-md shadow-sm py-3 px-4 text-base font-medium text-white hover:bg-black focus:outline-none focus:ring-0  transition ease-in-out duration-300"
          >
            Continue Shopping
          </Link>
        </div>
      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto pt-6 pb-24 px-4 sm:px-6 lg:px-8">
          {/* <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl"> */}
            {/* Shopping Cart Items{" "} */}
            {/* <span className="text-gray-500">{total_items > 0}</span> */}
          {/* </h1> */}
          <div className="mt-12 lg:grid lg:grid-cols-12 lg:gap-x-12 lg:items-start xl:gap-x-16 relative">
            ...
            <section
              ...
              className="m-auto max-w-2xl bg-gray-50 rounded-lg px-4 py-6 sm:p-6 lg:p-8 lg:mt-0 lg:col-span-5 lg:m-0 "
            >
              {items?.length !== 0 ? (
                <>
                  <h2
                ...
                <div className="flex flex-col items-center justify-center gap-3">
                  <h1 className="text-xl">¡Start shopping cart!</h1>
                </div>
              )}
