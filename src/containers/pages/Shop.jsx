...
function Products({
  ...
  const showProducts = () => {
    ...
    const productsList = filtered ? filtered_products : products;

    if (!productsList || productsList.length === 0) {
      return (
        <section class="flex flex-col items-center justify-cente text-center">
                ...
                >
                  <div className="ml-auto relative max-w-xs w-full h-full bg-white shadow-xl py-4 pb-12 flex flex-col overflow-y-auto">
                    ...
                    >
                      ...
                      <ul
                        role="list"
                        className="font-medium text-gray-900 px-2 py-2"
                      >
                        <p className="mx-2 mb-1">CATEGORIES</p>

                        {categories?.map((category, index) => {
                          return (
                            <Disclosure as="div" className=" px-2 pt-2">
                              {({ open }) => (
                                <>
                                        ...
                                        ? category.sub_categories.map(
                                            (sub_category) => (
                                              ...
                                              >
                                                ...
                                                />
                                                <label className="ml-3 min-w-0 flex-1 text-neutral-600 capitalize">
                                                  {sub_category.name}
                                                </label>
                                              </div>
                                            )
                      ...
                      >
                        {({ open }) => (
                          <>
                            <h3 className="-mx-2 -my-3 flow-root">
                              <Disclosure.Button className="px-2 py-2 bg-white w-full flex items-center justify-between text-gray-400 hover:text-gray-500">
                                <span
                                  className={classNames(
                                    open
                                      ? "text-orange-standard"
              ...
              >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
                  ...
                  >
                    ...
                    >
                      <p className="ml-1 mb-1 ">CATEGORIES</p>
                      {categories?.map((category, index) => {
                        return (
                          <Disclosure as="div" className=" px-1 pt-2">
                            {({ open }) => (
                              <>
                                <h3 className="-mx-2 -my-3 flow-root">
                                  <Disclosure.Button
                                    key={index}
                                    className="px-2 py-3 bg-white w-full flex items-center justify-between text-gray-400 hover:text-gray-500 lg:text-sm xl:text-base"
                                  >
                                    <span
                                      className={classNames(
                                        open
                                          ...
                                          (sub_category) => (
                                            ...
                                            >
                                              <input
                                                ...
                                                className="h-4 w-4 text-orange-standard border-gray-300 rounded-full focus:ring-0"
                                              />
                                              <label className="ml-3 min-w-0 flex-1 text-neutral-600 capitalize text-sm">
                                                {sub_category.name}
                                              </label>
                                            </div>
                                          )
                ...
                <div>
                  <div>
                    <CarouselProducts
                      ...
                      description={
                        "Products you may be interested in description"
                      }
                      data={categories}
                    />
                  </div>
