    ...
    <footer className="bg-gray-100 relative">
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
          Experience the purity of nature with our essential oils from doTERRA.
        ...
        <ul className="mt-12 flex justify-center gap-6 md:gap-8">
          <li>
            <a
              href="https://www.facebook.com/profile.php?id=61555258929112"
              rel="noreferrer"
              target="_blank"
              className="text-gray-700 transition hover:text-gray-700/75"
            >
          ...
          <li>
            <a
              href="https://www.instagram.com/essential_oils_dubai?igsh=YzljYTk1ODg3Zg=="
              rel="noreferrer"
              target="_blank"
              className="text-gray-700 transition hover:text-gray-700/75"
            >
