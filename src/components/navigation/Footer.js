...
function Footer(){
    return(
          ...
          <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div class="grid md:grid-cols-2 gap-8 mt-12 xl:mt-0 xl:col-span-2">
              <div class="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 class="text-xs font-semibold tracking-wider text-black uppercase">Solutions</h3>
                ...
                <div class="mt-12 md:mt-0">
                  <h3 class="text-xs font-semibold tracking-wider text-black uppercase">Support</h3>
                  <ul role="list" class="mt-4 space-y-4">
                    <li>
              ...
              <div class="lg:justify-end md:grid md:grid-cols-1">
                <div class="w-full mt-12 md:mt-0">
                  <div class="mt-8 lg:justify-end xl:mt-0">
                    <h3 class="text-xs font-semibold tracking-wider text-black uppercase">Subscribe to our newsletter</h3>
                    ...
                    <div class="inline-flex items-center gap-2 list-none lg:ml-auto">
                      <form action="" method="post" id="revue-form" name="revue-form" target="_blank" class="p-1 mt-4 transition duration-500 ease-in-out transform border2 bg-gray-50 rounded-xl sm:max-w-lg sm:flex">
                        ...
                        <div class="mt-4 sm:mt-0 sm:ml-3 revue-form-actions">
                          <button type="submit" value="Subscribe" name="member[subscribe]" id="member_submit" class="block w-full px-5 py-3 text-base font-medium text-white bg-orange-standard border border-transparent rounded-lg shadow hover:bg-button-standard-hover transition ease-in-out duration-300 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300 sm:px-10">Notify me</button>
                        </div>
                      </form>
                    </div>
                  </div>
        ...
        <div class="px-5 py-12 mx-auto bg-gray-100 max-w-7xl sm:px-6 md:flex md:items-center md:justify-around lg:px-20">
          ...
          <div class="mt-8 md:mt-0 md:order-1">
            <span class="mt-2 text-sm font-light text-gray-500">
              Copyright © 2023 - 2024
              <a href="https://wickedlabs.dev" class="mx-2 text-wickedblue hover:text-gray-500" rel="noopener noreferrer">@doTERRA</a>. Since 2023
            </span>
          </div>
        </div>
      </footer>
