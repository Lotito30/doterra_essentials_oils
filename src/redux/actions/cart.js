...
export const get_items = () => async (dispatch) => {
  if (localStorage.getItem("access")) {
    ...
    try {
      ...
      console.log(
        `Error response data get_item ${JSON.stringify(err.response.data)}`
      );
...
export const get_total = () => async (dispatch) => {
  if (localStorage.getItem("access")) {
    ...
    try {
      ...
      console.log(`Error response data get_total ${err.response.data}`);
...
export const get_item_total = () => async (dispatch) => {
  if (localStorage.getItem("access")) {
    ...
    try {
      ...
      console.log(`Error response data get_item_total ${err.response.data}`);
