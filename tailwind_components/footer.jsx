<footer class="bg-white" aria-labelledby="footer-heading">
        ...
        <div class="px-5 py-12 mx-full max-w-7xl lg:py-16 md:px-12 lg:px-20">
          <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="space-y-8 xl:col-span-1">
              <a class="text-lg font-bold tracking-tighter text-blue-600 transition duration-500 ease-in-out transform tracking-relaxed lg:pr-8" href="/"> doTERRA </a>
              <p class="w-1/2 mt-2 text-sm text-gray-500">doTERRA's Oils</p>
            </div>
